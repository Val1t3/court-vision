...
if __name__ == "__main__":
    ...
    # Init VideoManager
    vm = VideoManager(
        video_path="assets/extract-1.mp4", schema_path="assets/schema.png"
    )
    ...
    h, h_inv = tracker.calculate_homography_side(
        frame_points=bd.frame_points, schema_points=tracker.schema_pts, side="right"
    )
